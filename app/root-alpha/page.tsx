        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div className="font-mono text-synergy-gold font-bold text-lg">ROOT ALPHA</div>
            </div>
            
            <div className="hidden sm:flex items-center gap-6">
              <a href="/" className="text-interface-light hover:text-synergy-gold transition-colors">
                ← Back to RHIZ
              </a>
              <a href="#value" className="text-interface-light hover:text-synergy-gold transition-colors">
                Value
              </a>
              ...
              <a 
                href="https://buy.stripe.com/bJebJ0dgNcroeswgBvasg00" 
                target="_blank"
